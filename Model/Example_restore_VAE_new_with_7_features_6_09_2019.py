...
if __name__ == '__main__':
    ...
    # image_folder = 'C:/Users/nissa/PycharmProjects/DL/final-project-0.21/Images/Test_images/'
    # image_type = '*.jpg'
    # batch_size = 1
    # Read and analyze dataset
...
with tf.Session() as sess:
    ...
    for i in range(len(batches)):
        ...
        saver.restore(sess, './model_97.6863_epoch58_100Latent/saved_variable_VAE_Faces_56_06092019')
